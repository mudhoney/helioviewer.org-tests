...
test("Issue 680, Unicode processing of event labels", async ({ page }, info) => {
  ...
  await hekTree.assertEventInstanceTreeNodeLabel("Active Region", "NOAA SWPC Observer", "NOAA \u03B6-13814", "NOAA ζ-13814");
  await hekTree.assertEventInstanceTreeNodeLabel("Active Region", "NOAA SWPC Observer", "NOAA \u03B7-13815", "NOAA η-13815");
  await hekTree.assertEventInstanceTreeNodeLabel("Active Region", "NOAA SWPC Observer", "NOAA \u03B8-13816", "NOAA θ-13816");
  await hekTree.assertEventInstanceTreeNodeLabel("Active Region", "NOAA SWPC Observer", "NOAA \u03B9-13817", "NOAA ι-13817");
  await hekTree.assertEventInstanceTreeNodeLabel("Active Region", "NOAA SWPC Observer", "NOAA \u03BA-13818", "NOAA κ-13818");
  ...
  await ccmcTree.assertEventInstanceTreeNodeLabel("DONKI", "CME", "Type:A \u03C3 &quot;123km&quot;", "Type:A σ \"123km\"");
  ...
  await ccmcTree.assertEventInstanceTreeNodeLabel("Solar Flare Predictions", "AMOS", "C+ \u03C6% &amp; M+: 2.82%", "C+ φ% & M+: 2.82%");
  await ccmcTree.assertEventInstanceTreeNodeLabel("Solar Flare Predictions", "AMOS", "C+ \u03C7% &lt;M+&gt;: 9.08%", "C+ χ% <M+>: 9.08%");
  await ccmcTree.assertEventInstanceTreeNodeLabel("Solar Flare Predictions", "AMOS", "C+ \u03C8% &quot;X&quot;: 0%", "C+ ψ% \"X\": 0%");
  await ccmcTree.assertEventInstanceTreeNodeLabel("Solar Flare Predictions", "AMOS", "C+ \u03C9% &#39;M&#39;: 1.5%", "C+ ω% 'M': 1.5%");
  await ccmcTree.assertEventInstanceTreeNodeLabel("Solar Flare Predictions", "AMOS", "C+ \u0394% &deg;X: 0.1%", "C+ Δ% °X: 0.1%");
});
